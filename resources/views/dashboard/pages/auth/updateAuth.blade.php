...
@section('content')
    <div class="bg-cars">
        <img class="img-1"
            ...
            alt="">
        <img class="img-2"
            src="https://png.pngtree.com/png-vector/20240322/ourmid/pngtree-blue-super-car-png-image_12206099.png"
            alt="">
    </div>
    ...
    <div class="wrap-login-page">
        <div class="flex-grow flex flex-column gap30">
            ...
            <div class="login-box">
                ...
                <form class="form-login flex flex-column gap24" method="POST" action="{{ route('dashboard.update') }}">
                    ...
                    <fieldset class="password">
                        <div class="body-title mb-5">تأكيد كلمة المرور الجديدة <span class="tf-color-1">*</span></div>
                        <div class="password-box mb-1 mt-2">
                            <input class="password-input @error('password') is-invalid @enderror" type="password"  placeholder="اكتب كلمة المرور هنا ..."
