...
@section('content')
<div class="bg-cars">
    <img class="img-1" src="https://png.pngtree.com/png-vector/20240309/ourmid/pngtree-black-super-car-png-image_11921537.png" alt="">
    <img class="img-2" src="https://png.pngtree.com/png-vector/20240322/ourmid/pngtree-blue-super-car-png-image_12206099.png" alt="">
  </div>

<div class="wrap-login-page">
    <div class="flex-grow flex flex-column gap30">
      <a class="logo-login" href="javascript:;">
        <img src="assets/dashboard/images/logo/logo.svg" alt="logo">
      </a>
      ...
      <div class="login-box">
        ...
        <form class="form-login flex flex-column gap24" method="POST" action="{{ route('dashboard.check') }}">
           
                @csrf
          <fieldset class="email">
            <div class="body-title mb-5">البريد الالكتروني <span class="tf-color-1">*</span></div>
            <input class="flex-grow" type="email" placeholder="اكتب البريد الالكتروني هنا ..." name="email"
              required="">
          </fieldset>
          <fieldset class="password">
            <div class="body-title mb-5">كلمة المرور <span class="tf-color-1">*</span></div>
            <div class="password-box">
              <input class="password-input" type="password" placeholder="اكتب كلمة المرور هنا ..." name="password"
                required="">
              <span class="show-pass">
                <svg class="view" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                  color="#ffffff" fill="none">
                  <path d="M2 8C2 8 6.47715 3 12 3C17.5228 3 22 8 22 8" stroke="currentColor" stroke-width="1.5"
                ...
                <svg class="hide" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                  color="#ffffff" fill="none">
                  <path
